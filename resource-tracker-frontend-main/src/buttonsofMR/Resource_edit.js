...
function Resource_edit() {
  ...
  useEffect(() => {
    axios.get('https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/getAllUnassignedResources')
      .then(res => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/${resourceid}`)
      .then((res) => {
        const data = res.data;
        setResData(data);
        ...
        if (data.permissionId === 3) {
          axios.get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/getAllResourcesByManagerId/${resourceid}`)
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put("https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/update/upload", formData)
