...
function Resource_edit() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://candidate-tracker-app-f9bsavbvf8anayfy.centralindia-01.azurewebsites.net/api/v1/resource/${resourceid}`)
      .then((res) => {
        const data = res.data;
        setResData(data);
        ...
        if (data.permissionId === 3) {
          axios.get(`https://candidate-tracker-app-f9bsavbvf8anayfy.centralindia-01.azurewebsites.net/api/v1/resource/getAllResourcesByManagerId/${resourceid}`)
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put("https://candidate-tracker-app-f9bsavbvf8anayfy.centralindia-01.azurewebsites.net/api/v1/resource/update/upload", formData)
