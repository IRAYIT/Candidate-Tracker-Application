  ...
  useEffect(() => {
    ...
    if (sid) {
      axios
        ...
        .then((res) => {
          if (res.data.permissionId == 1) setRole('Admin');
          else if (res.data.permissionId == 2) setRole("Manager");
          ...
          <div className="max-w-5xl mx-auto my-8 p-8 bg-white rounded-lg shadow-md">
            ...
            {resData && (
              <div className="space-y-6">
                ...
                </div>  {/* ✅ This closing tag was MISSING in your original */}
                
                {/* Row 3: Technology & Skill */}
                <div className="flex flex-wrap gap-4 justify-between">
                  <div className="w-full md:w-[48%]">
                  ...
                  <div className="w-full md:w-[48%]">
                    ...
                    <div className="w-full border-2 border-yellow-400 p-2 rounded bg-gray-100 min-h-[38px] flex flex-wrap gap-2">
                      {skillsArray.map((skill, index) => (
                        <span key={index} className="inline-flex items-center bg-white border border-gray-300 text-gray-700 text-sm px-3 py-1 rounded-full">
                          {skill}
                        </span>
                      ))}
                    </div>
                ...
                {/* Row 4: Employment Type & Experience */}
                <div className="flex flex-wrap gap-4 justify-between">
                  <div className="w-full md:w-[48%]">
