...
function Resource_view() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/${sid}`)
      .then((res) => {
        const data = res.data;
        ...
        if (data.permissionId === 3) {
          ...
          axios
            .get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/getAllResourcesByManagerId/${sid}`)
