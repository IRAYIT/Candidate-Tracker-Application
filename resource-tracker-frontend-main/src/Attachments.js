...
const Attachments = (props) => {
  ...
  const fetchAttachments = async (resid) => {
    try {
      const res = await axios.get(
        `https://api.i-raysolutions.com/api/v1/attachment/getListAttachments/${resid}`
      );
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://api.i-raysolutions.com/api/v1/attachment/${attachmentId}`);
      fetchAttachments(resId);
    } catch (err) {
  ...
  const handleUpload = async () => {
    ...
    try {
      await axios.post("https://api.i-raysolutions.com/api/v1/attachment/upload", formData);
      fetchAttachments(resId);
  ...
  const handleView = async (id) => {
    try {
      const res = await axios.get(`https://api.i-raysolutions.com/api/v1/attachment/${id}`);
