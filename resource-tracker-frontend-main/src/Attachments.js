...
const Attachments = (props) => {
  ...
  const fetchAttachments = async (resid) => {
    try {
      const res = await axios.get(
        `https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/attachment/getListAttachments/${resid}`
      );
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/attachment/${attachmentId}`);
      fetchAttachments(resId);
    } catch (err) {
  ...
  const handleUpload = async () => {
    ...
    try {
      await axios.post("https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/attachment/upload", formData);
      fetchAttachments(resId);
  ...
  const handleView = async (id) => {
    try {
      const res = await axios.get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/attachment/${id}`);
