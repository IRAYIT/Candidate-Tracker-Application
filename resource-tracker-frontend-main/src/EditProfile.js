                ...
                <div className="flex flex-wrap gap-4 justify-between">
                  <div className="w-full md:w-[48%]">
                    ...
                    >
                      ...
                      <option value="Sweden-PartTime">Sweden-PartTime</option>
                      <option value="Sweden-Contract">Sweden-Contract</option>
                      <option value="India-FullTime">India-FullTime</option>
                      <option value="India-PartTime">India-PartTime</option>
                      <option value="India-Contract">India-Contract</option>
                      <option value="USA-FullTime">USA-FullTime</option>
                      <option value="USA-PartTime">USA-PartTime</option>
                      <option value="USA-Contract">USA-Contract</option>
                    </select>
