...
function ManageProjects() {
  ...
  useEffect(() => {
    ...
    // Admin (1), HR (2), Manager (3) — fetch all projects
    // Employee (4) — fetch only their own projects
  ...
  return (
    <>
                    ...
                    <thead className="bg-gradient-to-br from-blue-600 via-blue-400 to-yellow-400 text-white">
                      {table.getHeaderGroups().map((headerGroup) => (
                        <tr key={headerGroup.id}>
                          ...
                          <th className="px-6 py-3 text-left text-sm font-bold tracking-wide">
                            ACTIONS
                          </th>
                        </tr>
                      ))}
      ...
      {showDeleteModal && (
        ...
        >
          <div className="bg-white rounded-lg shadow-xl text-center" style={{ width: "350px", padding: "24px" }}>
