...
function ManageProjects() {
  ...
  const fetchProjects = async () => {
    try {
      const res = await axios.get(`https://candiate-tracker-aea8hqfwbxd4dqhu.centralindia-01.azurewebsites.netapi/v1/projects/list`);
  ...
  const fetchProjectByResource = async () => {
    try {
      ...
      const res = await axios.get(
        `https://candiate-tracker-aea8hqfwbxd4dqhu.centralindia-01.azurewebsites.netapi/v1/projects/getProjectsByResourceId/${id}`
      );
  ...
  const deleteproject = async (projectId) => {
    ...
    try {
      const res = await axios.delete(
        `https://candiate-tracker-aea8hqfwbxd4dqhu.centralindia-01.azurewebsites.netapi/v1/projects/${projectId}`
      );
