...
function ManageProjects() {
  ...
  const fetchProjects = async () => {
    try {
      const res = await axios.get(`https://api.i-raysolutions.com/api/v1/projects/list`);
  ...
  const fetchProjectByResource = async () => {
    try {
      ...
      const res = await axios.get(
        `https://api.i-raysolutions.com/api/v1/projects/getProjectsByResourceId/${id}`
      );
  ...
  const deleteproject = async (projectId) => {
    ...
    try {
      const res = await axios.delete(
        `https://api.i-raysolutions.com/api/v1/projects/${projectId}`
      );
