...
function ManageProjects() {
  ...
  const fetchProjects = async () => {
    try {
      const res = await axios.get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/projects/list`);
  ...
  const fetchProjectByResource = async () => {
    try {
      ...
      const res = await axios.get(
        `https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/projects/getProjectsByResourceId/${id}`
      );
  ...
  const deleteproject = async (projectId) => {
    ...
    try {
      const res = await axios.delete(
        `https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/projects/${projectId}`
      );
