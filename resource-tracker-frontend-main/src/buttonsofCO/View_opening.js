                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap gap-4 justify-between">
                    ...
                    <div className="w-full md:w-[48%]">
                      ...
                      <input type="text" value={location} readOnly className="border-2 border-yellow-400 p-2 rounded w-full" />
                    </div>
                  </div>
                  ...
                  <div className="w-full">
                    ...
                    <textarea value={description} readOnly className="border-2 border-yellow-400 p-2 rounded w-full resize-none" rows={5} />
                  </div>
