...
function Edit_opening() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/openings/${openingid}`)
      .then((res) => {
  ...
  const editopening = () => {
    ...
    axios
      .put("https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/openings", payload)
