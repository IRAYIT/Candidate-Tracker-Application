...
function RoleCard({ role, index, isFirst, onUpdate, onRemove, roleError }) {
  ...
  const fetchResources = useCallback(async (tech, customTech, skills) => {
    ...
    try {
      const res = await axios.post("https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/projects/getResourceNames", {
        permissionId: 3,
...
function Addproject() {
  ...
  const handleSubmit = () => {
    ...
    axios.post("https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/projects/createproject", payload)
