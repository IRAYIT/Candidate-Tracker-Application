...
function Forgotpassword() {
  ...
  const handleSendOtp = () => {
    ...
    setLoading(true);
    axios
      .post(`https://api.i-raysolutions.com/api/v1/user/sendOtp?email=${email}`)
      .then((res) => {
  ...
  const handleVerifyOtp = () => {
    ...
    setLoading(true);
    axios
      .post(`https://api.i-raysolutions.com/api/v1/user/verifyOtp?email=${email}&otp=${otp}`)
      .then((res) => {
  ...
  const handleReset = () => {
    ...
    setLoading(true);
    axios
      .post("https://api.i-raysolutions.com/api/v1/user/forgotPassword", {
        email,
