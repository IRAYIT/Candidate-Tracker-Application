...
function Forgotpassword() {
  ...
  const handleSendOtp = () => {
    ...
    setLoading(true);
    axios
      .post(`https://candiate-tracker-aea8hqfwbxd4dqhu.centralindia-01.azurewebsites.netapi/v1/user/sendOtp?email=${email}`)
      .then((res) => {
  ...
  const handleVerifyOtp = () => {
    ...
    setLoading(true);
    axios
      .post(`https://candiate-tracker-aea8hqfwbxd4dqhu.centralindia-01.azurewebsites.netapi/v1/user/verifyOtp?email=${email}&otp=${otp}`)
      .then((res) => {
