...
function Addresource() {
  ...
  const checkEmail = () => {
    ...
    axios.get(`https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/emailCheck/${email}`)
      .then(res => {
        if (res.status === 200) {
          setErrors(prev => ({
            ...prev,
  ...
  const save = () => {
    ...
    axios.post('https://candidate-tracker-iray-bhgbahe3bjame4gv.centralindia-01.azurewebsites.net/api/v1/resource/upload', formData)
